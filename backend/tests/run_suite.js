...
const ALL = [
  ...
  'verify_role_reconciliation', 'verify_routing_cutover', 'verify_taxonomy_variants', 'verify_variant_discovery', 'verify_mass_handoff', 'verify_legal_estimate', 'verify_sources_list', 'verify_notifications', 'verify_returned_rework', 'verify_task_lifecycle',
