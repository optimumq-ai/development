...
const ALL = [
  ...
  'verify_search_intents', 'verify_mrr_intake_prompt', 'verify_request_defect', 'verify_search_resolve',
  'verify_search_intent_gate', 'verify_fee_labor_gate', 'verify_fee_bounds', 'verify_estimate_profiles',
  'verify_role_reconciliation', 'verify_user_types', 'verify_setup_hub', 'verify_org_removal', 'verify_agency_setup', 'verify_fee_law', 'verify_request_rules', 'verify_actual_amounts', 'verify_routing_cutover', 'verify_taxonomy_variants', 'verify_variant_discovery', 'verify_mass_handoff', 'verify_library_destination', 'verify_fingerprint_discovery', 'verify_source_census', 'verify_census_association', 'verify_kind_census', 'verify_templates_from_samples', 'verify_ai_calls', 'verify_redaction_audit', 'verify_processing_audit', 'verify_processing_gates', 'verify_request_gates', 'verify_request_acts', 'verify_clock_disposition_gates', 'verify_onboarding_gates', 'verify_legal_estimate', 'verify_legal_line', 'verify_sources_list', 'verify_notifications', 'verify_returned_rework', 'verify_task_lifecycle',
  'verify_task_events_fk', 'verify_task_timing', 'verify_request_timeline', 'verify_time_budget', 'verify_work_timer',
  'verify_timecapture_config', 'verify_estimate_reconcile', 'verify_concurrent_tolls', 'verify_wrap_parent', 'verify_mrr_children',
  'verify_queue_parent_child', 'verify_legal_review', 'verify_rt_legal_gate', 'verify_fresh_install', 'verify_component_charged', 'verify_release_coverage', 'verify_revenue_allocation', 'verify_erp_line_items', 'verify_v1_retirement', 'verify_qa_routing', 'verify_nonpayment_scope',
