...
const ALL = [
  ...
  'verify_queue_parent_child', 'verify_legal_review', 'verify_fresh_install', 'verify_component_charged', 'verify_release_coverage', 'verify_revenue_allocation', 'verify_erp_line_items',
];
