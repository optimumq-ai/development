...
(async function () {
  ...
  ok('A2 thirty-six items (11 + 8 + 5 + 4 + 7 + the agency card on top; eligibility added, waiver_policy retired 2026-08-27)', HUB.ITEMS.length === 36 && HUB.ITEMS.filter(function (i) { return i.top; }).length === 1 &&
