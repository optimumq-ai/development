...
async function initDb() {
  ...
  // unhandled and the whole API crashes (found 2026-08-14: the test API died the moment the magic
  // reset terminated its idle connections). The pool discards the dead client and dials a fresh one
  // on the next query; in-flight queries on a terminated connection fail individually to their
  // callers, which is the honest outcome during a database swap.
