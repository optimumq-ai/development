...
router.put('/:recordTypeId', requireAuth, requirePermission('operations_config'), async function (req, res) {
  try {
    var b = req.body || {};
...
router.post('/:recordTypeId/actuals', requireAuth, requirePermission('operations_config'), async function (req, res) {
...
// Clear a profile.
router.delete('/:recordTypeId', requireAuth, requirePermission('operations_config'), async function (req, res) {
