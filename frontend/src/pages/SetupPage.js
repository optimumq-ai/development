...
const PHASE_META = {
  ...
  ownership:    { link: '/setup/taxonomy', linkLabel: 'Open Taxonomy', guide: "Confirm the owning City Department for each record type. AI proposes sensible defaults; you adjust." },
