...
- Auto-discovery counting groupings for mass-redaction candidates (Kevin's concept) `[NOT BUILT — next slice; design approved with the variant model, mockup 3]`.
