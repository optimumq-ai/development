...
4. **`extend(clockId, days, reason)`** — the one genuinely new engine primitive, for statutory volume extensions (IL § 3(e), CA § 7922.535(b)). `toll()` moves the due date by *elapsed wall time* and cannot express "+10 statutory days". **← next**
