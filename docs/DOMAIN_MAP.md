...
**Spec status:** ✅ = consolidated current-design spec exists · ⬜ = not yet done
...
## 4. ✅(partial) Tasks, Roles & My Tasks — `SPEC_tasks_roles_mrr_fees.md`
...
## 6. ✅(partial) Fees, Estimates & Payments — `SPEC_tasks_roles_mrr_fees.md` (intake/waiver) 
