...
**Status: RATIFIED — 2026-07-16. Items 1–7 all stand; nothing here is an open call.** Drafted 2026-07-08 from the verified domain specs and the root-cause analysis of the v1 structural failures. Every build (human or AI) conforms to this document.

> **Item 1 ratified 2026-07-16 by Kevin** — *"I want to make absolutely clear that you understand this is the model to be used."* Until that date this file said "pending Kevin's ratification" and named item 1 "the only open judgment call," while item 1's own heading already read ADOPTED. **That contradiction is a large part of why `BUILD_PRIORITY` item 11 sat unbuilt for thirteen sessions:** every fresh session read the contract as telling it the foundational decision was still open, and correctly took a smaller, unblocked slice instead. If you are tempted to leave a status line stale, this is what it costs.

## 1. Every request is wrapped in a parent (**RATIFIED 2026-07-16**; amended 2026-07-13; binding spec: `SPEC_parent_child_lifecycle.md`)
