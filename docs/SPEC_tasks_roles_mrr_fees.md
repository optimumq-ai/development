...
- **The display** of these clocks (days-in-queue/process per item, bottleneck view) is **Slice B**, still to build; Slice A only *records* the trail with enough fidelity for B and a future management dashboard.
