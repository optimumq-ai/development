...
const R = {
  fee: [
    [/nonpayment|denial_for_unpaid|unpaid_denial|forfeited_if_late|late_response|mandatory_prepayment|search_fee_conditional|search_fee_unreasonable_cost_gate|pre_charge_review/, '→payment'],
    ...
    [/estimate|itemi|advance_fee_notice|advance_estimate|pre_search_charge_notice|cost_mitigation|cost_estimate/, 'fee.estimate_and_notice'],
    ...
    [/special_service|customized_service|extensive|it_resource|enhanced_access_charge|enhanced_electronic|expedite_charge|voluminous_electronic_data_tiers/, 'fee.special_service_charge'],
    [/labor|search|retrieval|review_redaction|redaction_labor|redaction.*charge|review.*charge|staff_time|hourly_staff|personnel_time|research_retrieval|fringe_benefit|overtime|two_hour_threshold|threshold_hours|time_increment|attorney_review/, 'fee.labor_charge'],
    ...
    [/actual_cost|direct_cost|cost_of_duplication|duplication_actual|excluded_cost|supply_actual|location_cost|contractor|outside_service|compilation_cost|lowest_possible_cost|lowest_cost/, 'fee.actual_cost_basis'],
    [/per_page|copy_rate|page_rate|rate_per|copy_charge|copy_cost|standard_copy|duplication_rate|two_sided|media_differential|nonpaper_media/, 'fee.copy_rate_per_page'],
    [/.*/, 'fee.other_fee'],
  ],
  production: [
    ...
    [/no_duty|creation_not_required|no_format_conversion|no_encryption|reduce_to_written_form|no_refusal_for_query|no_new_record|not_obligated/, 'production.no_duty_to_create_or_convert'],
    ...
    [/electronic|format|native|_medium|requested_|preferred_format|tangible_medium|requester_format|physical_form|metadata|digital/, 'production.format_and_medium'],
    [/delivery|prompt_copy|entity_prepares|copy_duty|completion_duty|prompt_compliance|response_promptness|promptly|reasonable_time|readily/, 'production.delivery_and_completion'],
  ...
  intake: [
    ...
    [/technicality|incomplete_letter_denial|noncompliant_request_no_obligation|overbreadth_not_sole|good_faith_response|no_statutory_citation/, 'intake.no_technicality_denial'],
    ...
    [/reasonabl.*describ|reasonable_description|reasonable_specificity|reasonably_describes|request_description_specificity|specificity_required|clearly_indicate|identifiable_record|possession_custody_control|reasonable_time_place/, 'intake.reasonably_describes'],
  ...
  denial: [
    ...
    [/exemption|cite|statutory|legal_authority|factual_basis|specific_reason|reasons?_stated|reasons?_required|grounds?|reason_for_denial|explain|specificity|itemize_withheld|notice_contents|notice_and_statutory|statement_of_reasons|withholding_index|index_privileged|ground_exemption/, 'denial.reasons_and_citation_required'],
    [/written|in_writing|notice_required|form_of_denial/, 'denial.written_notice_required'],
    [/appeal|review/, '→appeal'],
    [/.*/, 'denial.other_denial'],
  ],
  payment: [
    [/cost_estimate_notice_threshold|pre_charge_review_objection|after_hours_compensation/, '→fee'],
    ...
    [/before_copy|before_produc|before_search|precondition|before_release|release_on_payment|upon_payment|fee_before_copies|fee_suspends_response|fee_tender|full_payment_at_production|suspends|deferral_pending|collection_of_agreed|commercial_fee_precondition/, 'payment.production_conditioned_on_payment'],
  ...
  redaction: [
    [/election_records_limit|not_new_record/, '→special_records'],
    [/separation_cost|cost_allocation/, '→fee'],
    [/segregab|reasonably_segregable|redact_and_release|nonexempt.*portion|separable|segregate_and_release|separate_exempt|redact_and_produce|commingled_no_denial|design_for_separation|redaction_is_denial/, 'redaction.segregability'],
    ...
    [/personnel|employee|medical|privacy_notice|objection/, 'redaction.personnel_privacy_process'],
  ...
  classification: [
    [/presumption|openness|open_by_default/, 'classification.presumption_of_openness'],
  ...
  search: [
    [/reasonable_search|adequate_search|good_faith_search|diligent/, 'search.reasonable_search_duty'],
  ...
  definition: [ [/.*/, 'classification.definition_misc'] ],
